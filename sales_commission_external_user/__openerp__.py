...
{
    'name' : 'Sales Commission by Sales/Invoice/Payment by External User/Level',
    'version' : '1.0',
    'price' : 152.0,
    'currency': 'EUR',
    'category': 'Sales',
...
Commission amount will be based on Net Revenue Model where it consider amounts without taxes. (This module does not support Gross Margin Model)
            ...
            """,
    'summary' : 'This module provide feature to manage sales commision by Sales/Invoice/Payments by Multi User/Level',
